...
public class RegistrationService {
    ...
    private String primary_password = "TtsSparklab";
    ...
    public ResponseEntity<?> registerUser(RegisterDTO registerDTO) throws AddressException {
        ...
        if (userRepository.existsByEmail(registerDTO.getEmail()) == TRUE) {
            ...
            userToSave.setSurname(registerDTO.getSurname());
        ...
        try {
            ...
            String link = "http://localhost:3000/tts/registration/" + userToSave.getConfirmationToken();
            emailService.send(registerDTO.getEmail(), emailService.buildEmail(registerDTO.getName(), link));
